...
import RevealAnimation, { StaggerContainer, StaggerItem } from './animations/RevealAnimation';
  ...
  return (
    <section id="skills" className="section-padding bg-gray-50 dark:bg-gray-800">
      <div className="container-custom">
        ...
        {/* Skills Grid */}
        <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" staggerDelay={0.1}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {[
              ...
              >
                ...
                <h4 className={`text-lg font-semibold ${tech.color} group-hover:text-primary-600 transition-colors duration-300`}>
                  {tech.name}
                </h4>
              </motion.div>
            ))}
